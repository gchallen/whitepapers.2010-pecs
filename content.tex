We envision a publicly-available smartphone testbed called \emph{PhoneLab}
...
%TK: These examples are too specific. We need to talk about more general research issues related to each

%One of the authors, Murat
